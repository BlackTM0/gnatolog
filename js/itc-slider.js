...
const sliderElements = document.querySelectorAll('[data-slider="itc-slider"]');

// Создаем экземпляр и запускаем автопрокрутку для каждого элемента
sliderElements.forEach(element => {
  ItcSlider.getOrCreateInstance(element).autoplay.start();
});
